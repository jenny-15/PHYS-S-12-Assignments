...
I think that this whole experience has been very worthwhile. Although this project did not turn out as I expected, I will definitely work on my protoboard after this class ends and get the radio modules to work. I will probably just start with a new protoboard and nrf24l01 and solder the connections again. Something that I would like to try is creating a program that runs automaticallly when my computer turns on. This way, whenever my computer is on the program will send something to the Arduino and the circuit will run. I do not have any prior experience with coding, so I do not know how to go about doing this. I think that this may exceed what I am capable of for now, but I will definitely learn more about computer science on the future. I do not know how to create the automatic program or send it to an Arduino from my computer. I have tried researching how to do this before, but I did not find anything that was very helpful.

This entire class has been very interesting. Everything that I was exposed to was pretty new to me, and much of it was not anything that I could have learned in school. This has been very a eye-opening class since I got to learn about many diffrent fields within technology and where they are going. I am definitely something that I am interested in exploring these topics further! The device that I made not overly complicated. However, it was a great first project for me and the idea behind it can make a huge impact. I look forward to trying more complex projects with the skills that I have learned in this class. 
